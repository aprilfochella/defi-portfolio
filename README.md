...
<p align="center">
  <sub>lp · pnl · csv export</sub>
</p>

<p align="center">
  <code>.NET 10</code> &nbsp;·&nbsp; <code>MIT</code> &nbsp;·&nbsp; <code>DefiPort</code> &nbsp;·&nbsp; <code>defiport</code>
</p>
...
DeFi portfolio tracker — LP positions, rough IL display, CSV for spreadsheets.

defi-portfolio beats branded names in organic search.
...
```bash
dotnet restore defi-portfolio.slnx
dotnet build defi-portfolio.slnx -c Release
dotnet test defi-portfolio.slnx -c Release
```
